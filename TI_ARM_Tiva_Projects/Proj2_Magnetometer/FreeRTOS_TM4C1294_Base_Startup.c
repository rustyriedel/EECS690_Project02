...
void (* const g_pfnVectors[])(void) =
{
	...
	// The initial stack pointer
		...
		IntDefaultHandler,// Timer 0 subtimer A  @Alexander Kimani
...
static void FaultISR(void) {
	//
	//	Store all the registers. We assume R0-R3 have been saved on the stack
	//
	//SaveGeneralRegisters();
	//SaveFloatingPointRegisters();
	//
	// Enter an infinite loop.
	//
	while (1) {
