...
;* Date/Time created: Mon Oct 03 09:38:57 2016                                *
;******************************************************************************
...
;	C:\ti\ccsv6\tools\compiler\arm_15.12.3.LTS\bin\armacpia.exe -@C:\\DOCUME~1\\ADMINI~1\\LOCALS~1\\Temp\\0386812 
	.sect	".text"
	.clink
...
$C$DW$54	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 73,column 2,is_stmt,isa 1
        ...
        MOVS      A2, #255              ; [DPU_3_PIPE] |73| 
        MOVS      A3, #20               ; [DPU_3_PIPE] |73| 
$C$DW$55	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$55, DW_AT_low_pc(0x00)
	.dwattr $C$DW$55, DW_AT_name("TimerPrescaleSet")
	.dwattr $C$DW$55, DW_AT_TI_call

        BL        TimerPrescaleSet      ; [DPU_3_PIPE] |73| 
        ; CALL OCCURS {TimerPrescaleSet }  ; [] |73| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 75,column 2,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |75| 
        MOVS      A2, #255              ; [DPU_3_PIPE] |75| 
        MOV       A3, #60000            ; [DPU_3_PIPE] |75| 
$C$DW$56	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$56, DW_AT_low_pc(0x00)
	.dwattr $C$DW$56, DW_AT_name("TimerLoadSet")
	.dwattr $C$DW$56, DW_AT_TI_call

        BL        TimerLoadSet          ; [DPU_3_PIPE] |75| 
        ; CALL OCCURS {TimerLoadSet }    ; [] |75| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 77,column 2,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |77| 
        MOVS      A2, #255              ; [DPU_3_PIPE] |77| 
$C$DW$57	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$57, DW_AT_low_pc(0x00)
	.dwattr $C$DW$57, DW_AT_name("TimerEnable")
	.dwattr $C$DW$57, DW_AT_TI_call

        BL        TimerEnable           ; [DPU_3_PIPE] |77| 
        ; CALL OCCURS {TimerEnable }     ; [] |77| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 79,column 2,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |79| 
        MOVS      A2, #1                ; [DPU_3_PIPE] |79| 
$C$DW$58	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$58, DW_AT_low_pc(0x00)
	.dwattr $C$DW$58, DW_AT_name("TimerIntEnable")
	.dwattr $C$DW$58, DW_AT_TI_call

        BL        TimerIntEnable        ; [DPU_3_PIPE] |79| 
        ; CALL OCCURS {TimerIntEnable }  ; [] |79| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 80,column 2,is_stmt,isa 1
        MOVS      A1, #35               ; [DPU_3_PIPE] |80| 
$C$DW$59	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$59, DW_AT_low_pc(0x00)
	.dwattr $C$DW$59, DW_AT_name("IntEnable")
	.dwattr $C$DW$59, DW_AT_TI_call

        BL        IntEnable             ; [DPU_3_PIPE] |80| 
        ; CALL OCCURS {IntEnable }       ; [] |80| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 82,column 2,is_stmt,isa 1
        MOVS      A1, #1                ; [DPU_3_PIPE] |82| 
        MOVS      A2, #0                ; [DPU_3_PIPE] |82| 
        MOVS      A3, #3                ; [DPU_3_PIPE] |82| 
$C$DW$60	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$60, DW_AT_low_pc(0x00)
	.dwattr $C$DW$60, DW_AT_name("xQueueGenericCreate")
	.dwattr $C$DW$60, DW_AT_TI_call

        BL        xQueueGenericCreate   ; [DPU_3_PIPE] |82| 
        ; CALL OCCURS {xQueueGenericCreate }  ; [] |82| 
        LDR       A3, $C$CON1           ; [DPU_3_PIPE] |82| 
...
$C$DW$61	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$61, DW_AT_TI_call
        ...
        BL        xQueueGenericSend     ; [DPU_3_PIPE] |82| 
        ; CALL OCCURS {xQueueGenericSend }  ; [] |82| 
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 83,column 9,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L3||
;*
;*   Loop source line                : 83
...
;* --------------------------------------------------------------------------*
||$C$L3||:    
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 100,column 3,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |100| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |100| 
        MOVS      A2, #0                ; [DPU_3_PIPE] |100| 
        MOV       A3, #-1               ; [DPU_3_PIPE] |100| 
...
$C$DW$62	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$62, DW_AT_TI_call
        ...
        BL        xQueueGenericReceive  ; [DPU_3_PIPE] |100| 
        ; CALL OCCURS {xQueueGenericReceive }  ; [] |100| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 101,column 3,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |101| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |101| 
        CMP       A1, #99               ; [DPU_3_PIPE] |101| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |101| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |101| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 102,column 4,is_stmt,isa 1
        LDR       A2, $C$CON5           ; [DPU_3_PIPE] |102| 
        MOVS      A1, #0                ; [DPU_3_PIPE] |102| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |102| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 103,column 4,is_stmt,isa 1
        LDRB      A1, [SP, #10]         ; [DPU_3_PIPE] |103| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |103| 
        STRB      A1, [SP, #10]         ; [DPU_3_PIPE] |103| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 104,column 4,is_stmt,isa 1
        LDR       A1, $C$CON5           ; [DPU_3_PIPE] |104| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |104| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |104| 
        LDRB      A3, [SP, #9]          ; [DPU_3_PIPE] |104| 
        LDRB      A4, [SP, #10]         ; [DPU_3_PIPE] |104| 
        LDRB      A2, [SP, #8]          ; [DPU_3_PIPE] |104| 
        ADR       A1, $C$SL1            ; [DPU_3_PIPE] |104| 
$C$DW$63	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$63, DW_AT_low_pc(0x00)
	.dwattr $C$DW$63, DW_AT_name("UARTprintf")
	.dwattr $C$DW$63, DW_AT_TI_call

        BL        UARTprintf            ; [DPU_3_PIPE] |104| 
        ; CALL OCCURS {UARTprintf }      ; [] |104| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 106,column 4,is_stmt,isa 1
        LDRB      A1, [SP, #10]         ; [DPU_3_PIPE] |106| 
        CMP       A1, #59               ; [DPU_3_PIPE] |106| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |106| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |106| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 107,column 5,is_stmt,isa 1
        LDRB      A1, [SP, #9]          ; [DPU_3_PIPE] |107| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |107| 
        STRB      A1, [SP, #9]          ; [DPU_3_PIPE] |107| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 108,column 5,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |108| 
        STRB      A1, [SP, #10]         ; [DPU_3_PIPE] |108| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 109,column 5,is_stmt,isa 1
        LDRB      A1, [SP, #9]          ; [DPU_3_PIPE] |109| 
        CMP       A1, #59               ; [DPU_3_PIPE] |109| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |109| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |109| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 110,column 6,is_stmt,isa 1
        LDRB      A1, [SP, #8]          ; [DPU_3_PIPE] |110| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |110| 
        STRB      A1, [SP, #8]          ; [DPU_3_PIPE] |110| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 111,column 6,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |111| 
        STRB      A1, [SP, #9]          ; [DPU_3_PIPE] |111| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 112,column 6,is_stmt,isa 1
        LDRB      A1, [SP, #8]          ; [DPU_3_PIPE] |112| 
        CMP       A1, #23               ; [DPU_3_PIPE] |112| 
        BNE       ||$C$L3||             ; [DPU_3_PIPE] |112| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |112| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 113,column 7,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |113| 
        STRB      A1, [SP, #8]          ; [DPU_3_PIPE] |113| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 83,column 9,is_stmt,isa 1
        B         ||$C$L3||             ; [DPU_3_PIPE] |83| 
        ; BRANCH OCCURS {||$C$L3||}      ; [] |83| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$45, DW_AT_TI_end_file("../Tasks/Task_TimerInterrupt.c")
	.dwattr $C$DW$45, DW_AT_TI_end_line(0x79)
...
$C$DW$64	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 126,column 34,is_stmt,address Timer_0_A_ISR_Handler,isa 1
...
;* --------------------------------------------------------------------------*
	...
	.dwcfi	save_reg_to_mem, 14, -4
	.dwcfi	save_reg_to_mem, 3, -8
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 127,column 2,is_stmt,isa 1
        LDR       A2, $C$CON5           ; [DPU_3_PIPE] |127| 
        LDR       A1, [A2, #0]          ; [DPU_3_PIPE] |127| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |127| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |127| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 134,column 2,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |134| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |134| 
...
$C$DW$66	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$66, DW_AT_TI_call
        ...
        BL        xQueueGiveFromISR     ; [DPU_3_PIPE] |134| 
        ; CALL OCCURS {xQueueGiveFromISR }  ; [] |134| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 135,column 2,is_stmt,isa 1
        LDR       A1, $C$CON6           ; [DPU_3_PIPE] |135| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |135| 
        CBZ       A1, ||$C$L4||         ; [] 
        ; BRANCHCC OCCURS {||$C$L4||}    ; [] |135| 
;* --------------------------------------------------------------------------*
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |135| 
        MOV       A1, #268435456        ; [DPU_3_PIPE] |135| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |135| 
	dsb
	isb
;* --------------------------------------------------------------------------*
||$C$L4||:    
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 140,column 2,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |140| 
...
$C$DW$67	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$67, DW_AT_TI_call
        ...
        BL        TimerIntClear         ; [DPU_3_PIPE] |140| 
        ; CALL OCCURS {TimerIntClear }   ; [] |140| 
	.dwpsn	file "../Tasks/Task_TimerInterrupt.c",line 141,column 1,is_stmt,isa 1
$C$DW$68	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$64, DW_AT_TI_end_line(0x8d)
